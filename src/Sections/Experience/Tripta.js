const Tripta = () => {
    return (
        ...
        <br></br>
            ...
            <li>Created a proxy server using Python and Flask to monitor the network traffic of the company's internal webapp.</li>
            <li>Assisted in developement of the company's internal webapp using Angular, MSSQL and C#.</li>
        </div>
    );
}

export default Tripta;