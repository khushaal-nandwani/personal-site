...
function ProjectsList({ handleLinkClick }) {
    return (
        <div className="flex flex-col gap-4 ">
          ...
          <div className='flex flex-row items-baseline gap-4 hover:scale-125 transition-transform cursor-pointer' onClick={() => handleLinkClick('frogger', 1)}> <p className="text-xl ">Frogger</p> <p className="text-sm italic">Assembly</p></div>
